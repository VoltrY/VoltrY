...
const enes = {
  ...
  operatingSystem: {
    ...
    execution: "Build fast",
    validation: "Measure honestly",
    iteration: "Improve relentlessly"
  }
};
```
...
<p align="center">
AI-powered voice infrastructure for automating business calls and customer operations.
</p>
...
<p align="center">
A healthcare platform for clinical workflows, medical data processing and DICOM analysis.
</p>
...
```text
01. Useful beats impressive.
02. Shipping beats endless planning.
03. Simple interfaces require serious engineering.
04. Real users reveal the truth.
05. Build. Measure. Learn. Repeat.
```
